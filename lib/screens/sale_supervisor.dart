...
class SupervisorSalesScreen extends ConsumerStatefulWidget {
  const SupervisorSalesScreen({super.key});

  @override
  ConsumerState<SupervisorSalesScreen> createState() =>
      _SupervisorSalesScreenState();
}

class _SupervisorSalesScreenState extends ConsumerState<SupervisorSalesScreen> {
