...
class SupervisorOutletScreen extends ConsumerStatefulWidget {
  const SupervisorOutletScreen({super.key});

  @override
  ConsumerState<SupervisorOutletScreen> createState() =>
      _SupervisorOutletScreenState();
}

class _SupervisorOutletScreenState
    extends ConsumerState<SupervisorOutletScreen> {
            ...
            child: StreamBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  final documents = snapshot.data
                      ?.where((element) =>
                          element['distributor']['supervisor']['email'] ==
